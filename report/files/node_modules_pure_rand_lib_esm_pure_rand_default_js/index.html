...
<head>
  <meta charset="utf-8">
  <title>Plato - node_modules/pure-rand/lib/esm/pure-rand-default.js</title>
...
<div class="jumbotron">
  <div class="container">
    <h1>node_modules/pure-rand/lib/esm/pure-rand-default.js</h1>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <textarea id="file-source" class="col-md-12">import { generateN, skipN, unsafeGenerateN, unsafeSkipN } from &#039;./generator/RandomGenerator.js&#039;;
...
export { __type, __version, __commitHash, generateN, skipN, unsafeGenerateN, unsafeSkipN, congruential32, mersenne, xorshift128plus, xoroshiro128plus, uniformArrayIntDistribution, uniformBigIntDistribution, uniformIntDistribution, unsafeUniformArrayIntDistribution, unsafeUniformBigIntDistribution, unsafeUniformIntDistribution, };</textarea>
  </div>
</div>
