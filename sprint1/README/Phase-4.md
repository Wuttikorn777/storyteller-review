...
**สิ่งที่ยังไม่สมบูรณ์ Bug / Error**<br> 
1. ในหน้าของ moviedetail ยังไม่สามารถที่จะบันทึกเรตติ้งแล้วแสดงปรับค่าได้ และยังไม่สามารถแสดงความคิดเห็นในหนังเรื่องนั้นได้
2. ในหน้าของ bookmark ยังไม่สามารถแยกได้ตามผู้ใช้ได้ แต่สามารถบันทึกและแสดงว่าใครใช้อยู่ได้
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;จะมุ่งเน้นเรื่องการทดสอบฟังก์ชันต่างๆ ด้วยการสร้าง Unit Test Cases ที่ครอบคลุมทุกฟังก์ชันหลักของระบบ เพื่อให้มั่นใจว่าทุกอย่างทำงานได้อย่างถูกต้อง นอกจากนี้ยังได้ดำเนินการ Static Profiling และ Dynamic Profiling เพื่อตรวจสอบประสิทธิภาพการทำงานของเว็บไซต์ในด้านต่างๆ และมีการจัดประชุม Retrospective เพื่อสะท้อนผลการทำงานและหาทางปรับปรุงกระบวนการใน Sprint ถัดไป เพื่อให้การทำงานในโปรเจคมีประสิทธิภาพยิ่งขึ้น
<br>
...
*   Bookmarks API
    *   ให้ผู้ใช้สามารถบันทึกภาพยนตร์ที่สนใจไว้
    *   รองรับการเพิ่ม, ดู, และลบรายการ
    *   ทำงานร่วมกับระบบไฟล์หรือฐานข้อมูลที่จัดเก็บข้อมูลบุ๊คมาร์ค
*   Reviews API
    *   ผู้ใช้สามารถเขียนและอ่านความคิดเห็นเกี่ยวกับภาพยนตร์
    *   ข้อมูลรีวิวถูกจัดเก็บเป็น JSON หรือฐานข้อมูลแบบ NoSQL
*   Ratings API
    *   ให้ผู้ใช้งานให้คะแนนภาพยนตร์เป็นตัวเลข (เช่น 1-5 ดาว)
    *   รองรับการดึงค่าเฉลี่ยหรือคะแนนรายคน
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;เนื่องจากในระหว่างกระบวนการพัฒนาเว็บไซต์และการปรับโครงสร้างโมเดล (model) เพื่อให้ระบบทำงานได้อย่างถูกต้องตามเกณฑ์ของ Data Structure ที่กำหนด จึงทำให้โค้ดใน Phase 4 ถูกสร้างใหม่จาก Phase 3 เพื่อให้ตรงกับข้อกำหนดที่ต้องการ ผลลัพธ์ที่ได้จากการเปรียบเทียบระหว่าง Phase 3 และ Phase 4 จึงไม่สามารถใช้ได้ เนื่องจากมีการเปลี่ยนแปลงที่สำคัญในโครงสร้างของโค้ด โดยไฟล์ใหม่ที่เพิ่มเข้ามา คือ ไฟล์ bookmarkModel.js , commentModel.js , ratingModel.js และไฟล์ที่ถูกลบออกไป คือ ไฟล์ models.movieData.test.js , models.userData.test.js
